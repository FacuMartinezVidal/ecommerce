        ...
        <div className="max-w-[900px] gap-2 grid grid-cols-12 grid-rows-2 px-8">
            ...
            <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-5">
                ...
                <CardFooter
                    ...
                    <Button className="text-tiny font-bold bg-gradient-to-r from-[#FF1CF7] to-[#b249f8]" radius="full"
                            size="sm">
                        Notify Me
                    </Button>
                </CardFooter>
            ...
            <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7">
                ...
                <CardFooter
                    ...
                    <Button radius="full" className="font-bold bg-gradient-to-r from-[#FF1CF7] to-[#b249f8]" size="sm">Get
                        App</Button>
                </CardFooter>
            </Card>
        </div>
